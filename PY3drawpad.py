...
btn_yellow = tk.Button(controls, text="Yellow", command=set_yellow)
btn_yellow.grid(row=0, column=4, padx=2)
btn_eraser = tk.Button(controls, text="Eraser", command=set_eraser)
btn_eraser.grid(row=0, column=5, padx=2)
...
size_label.grid(row=0, column=6, padx=6)

size_scale = tk.Scale(controls, from_=1, to=50, orient="horizontal", command=change_size)
size_scale.set(5)
...
clear_btn.grid(row=0, column=8, padx=6)
